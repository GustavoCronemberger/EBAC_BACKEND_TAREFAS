...
import br.com.gustavokt.DAO.factory.ProdutoQuantidadeFactory;
import br.com.gustavokt.DAO.factory.VendaFactory;
import br.com.gustavokt.DAO.generic.GenericDAO;
import br.com.gustavokt.domain.ProdutoQuantidade;
...
//		return venda;
        ...
        try {
            ...
            rs = stm.executeQuery();
            if (rs.next()) {
                Venda venda = VendaFactory.convert(rs);//Criação de uma factory para converter o rs em venda.
    ...
    private void buscarAssociacaoVendaProdutos(Connection connection, Venda venda)
        ...
        try {
            ...
            sbProd.append("P.ID AS ID_PRODUTO, P.CODIGO, P.NOME, P.DESCRICAO, P.VALOR, P.DATA_FABRICACAO ");
