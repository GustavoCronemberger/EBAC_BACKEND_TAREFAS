package br.com.gustavokt.domain.jpa;
...
public class VendaJpa implements Persistente {
    ...
    //JoinColumn especifica a coluna que será usada para unir duas entidades. id_cliente_fk pega Cliente e coloca dentro de Venda.
    @ManyToOne
    ...
    /**
     *Mapped “venda”: Especifica que o campo venda na entidade ProdutoQuantidadeJpa é o responsável por manter a relação.
     *Em outras palavras, a entidade ProdutoQuantidadeJpa tem um campo chamado venda que mapeia de volta para a entidade “Venda”.
     *Cascade.all Define que todas as operações de persistência (como persistir, mesclar, remover, etc.) realizadas na entidade Venda
     *serão automaticamente propagadas para as entidades ProdutoQuantidadeJpa associadas.
     *Isso é útil para garantir que as operações no banco de dados sejam consistentes e completas.
     *Não existe ProdutoQuantidade sem a Venda.
     **/
