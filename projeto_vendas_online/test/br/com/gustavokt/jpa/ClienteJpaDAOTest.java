package br.com.gustavokt.jpa;

import br.com.gustavokt.DAO.jpa.ClienteJpaDAO;
import br.com.gustavokt.DAO.jpa.IClienteJpaDAO;
...
public class ClienteJpaDAOTest {
    ...
    private Random rd;//Gerar número aleatório
    ...
    public void alterarCliente() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        clienteConsultado.setNome("Gustavo KT");
        clienteDao.alterar(clienteConsultado);

        ClienteJpa clienteAlterado = clienteDao.consultar(clienteConsultado.getId());
        Assert.assertNotNull(clienteAlterado);
        Assert.assertEquals("Gustavo KT", clienteAlterado.getNome());
